= Kubernetes on Joyent: The Hard Way


[[infrastructure]]
== Cloud Infrastructure Provisioning

This tutorial can be used for running an example HA Kubernetes cluster using the Joyent public cloud.
...
_The bulk of this series is Copyrighted by Kelsey Hightower and used under the Apache license. The original text and license can be found on link:https://github.com/kelseyhightower/kubernetes-the-hard-way[Github]_
