...
....
proxyssh root@$IP <<< "
wget --no-verbose -P /usr/local/bin/ https://storage.googleapis.com/kubernetes-release/release/v1.5.2/bin/linux/amd64/{kube-apiserver,kube-controller-manager,kube-scheduler,kubectl}
...
....
proxyssh root@$IP <<< "
wget --no-verbose -P /usr/bin https://storage.googleapis.com/kubernetes-release/release/v1.5.2/bin/linux/amd64/{kubectl,kube-proxy,kubelet}
...
....
ssh root@$BASTION <<< "
wget --no-verbose -P /usr/local/bin/ https://storage.googleapis.com/kubernetes-release/release/v1.5.2/bin/linux/amd64/kubectl
